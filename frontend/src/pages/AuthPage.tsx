    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-surface-tint lg:flex">
        ...
        <div className="relative z-10 mx-auto flex h-full w-full max-w-xl flex-col justify-between p-8 pt-16">
          <a className="inline-flex items-center gap-2 text-on-primary">
      ...
      {/* Right auth panel */}
      <div className="relative z-10 flex w-full items-center justify-center bg-surface p-6 lg:w-1/2">
                ...
                <form onSubmit={loginForm.handleSubmit(onLogin)} className="space-y-4">
                  ...
                  <div>
                    <div className="mb-1 flex items-center justify-between">
                      <label className="block text-label-sm text-on-surface">Mật khẩu</label>
                      <a className="text-label-sm text-primary hover:underline">Quên mật khẩu?</a>
                    </div>
